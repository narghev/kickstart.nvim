...
do
  ...
  -- [[ Colorscheme ]]
  -- Colorscheme is installed and loaded from `lua/custom/plugins/gruvbox-material.lua`.
...
do
  ...
  vim.keymap.set({ 'n', 'v' }, '<leader>f', function() require('conform').format { async = true, lsp_format = 'never' } end, { desc = '[F]ormat buffer' })
end
